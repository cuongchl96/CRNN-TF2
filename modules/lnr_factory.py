...
class CosineDecayWithWarmup(tf.keras.optimizers.schedules.LearningRateSchedule):
    ...
    def __init__(self, base_lr: int, total_steps: int, warmup_steps: int):
        ...
        self._init_learning_rate = base_lr
        self._warmup_steps = warmup_steps
    ...
    def __call__(self, global_step: int):
        ...
        self.learning_rate = tf.where(global_step < warmup_steps, linear_warmup,
